...
const staff = [
  { id: 1, name: "Suresh Reddy", email: "suresh@hc.edu", role: "Lab Technician", initials: "SR" },
  { id: 2, name: "Kavita Das", email: "kavita@hc.edu", role: "Lab Assistant", initials: "KD" },
];
  ...
  return (
    <DashboardLayout sidebarItems={sidebarItems} role="Admin" roleBadgeClass="badge-admin" userName="Dr. Admin">
      <div className="space-y-6">
        ...
        <DataTable
          columns={[
            { header: "Photo", accessor: (row) => <div className="h-10 w-10 rounded-full bg-destructive/10 flex items-center justify-center"><span className="text-sm font-bold text-destructive">{row.initials}</span></div> },
        ...
        />
        <DetailModal open={showModal} onClose={() => setShowModal(false)} title="Add Lab Staff">
