      ...
      <div className="bg-card rounded-xl border border-border p-8 shadow-sm">
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
          ...
          <div className="text-center sm:text-left">
            <h2 className="text-xl font-bold font-display text-foreground">Dr. Sharma</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            { label: "Full Name", value: "Dr. Rajesh Sharma" },
            { label: "Email", value: "sharma@healthcenter.edu" },
            { label: "Qualification", value: "MD Medicine" },
            { label: "Experience", value: "10 years" },
            { label: "Specialization", value: "General Medicine" },
            { label: "Employee ID", value: "DOC-001" },
          ].map((item) => (
            <div key={item.label}>
